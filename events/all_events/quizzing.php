...
<div class="content">
    <div class="grid">
        ...
        <a class="grid__item" href="#preview-2">
            <div class="box">
                <div class="box__shadow"></div>
                <img class="box__img" src="img/gen_main.jpg" alt="Some image" />
                <h3 class="box__title"><span class="box__title-inner" data-hover="15K">15K</span></h3>
        ...
        <a class="grid__item" href="#preview-3">
            <div class="box">
                <div class="box__shadow"></div>
                <img class="box__img" src="img/brainwaves.jpg" alt="Some image" />
        ...
        <a class="grid__item" href="#preview-4">
            <div class="box">
                <div class="box__shadow"></div>
                <img class="box__img" src="img/ockhamsrazor.jpg" alt="Some image" />
                <h3 class="box__title box__title--bottom"><span class="box__title-inner" data-hover="10k">10k</span></h3>
...
<div class="overlay">
    ...
    <div class="overlay__item" id="preview-1">
        <div class="box">
            <div class="box__shadow"></div>
            <img class="box__img box__img--original" src="img/melaquiz.jpg" alt="Some image" />
            <h3 class="box__title"><span class="box__title-inner">15K</span></h3>
            <img class="box__img box__img--original" src="img/MELA Quiz.jpg" alt="Some image" />
            <h4 class="box__text"><span class="box__text-inner">MELA Quiz</span></h4>
            <div class="box__deco">&#10014;</div>
        </div>
        <div class="overlay__content">
            <div class="myBtn">
                <a href="register.php?event=MELA QUIZ" data-title="Register"></a>
            </div>
            <p>Abbreviated as Music Entertainment Literary Arts Quiz.If you love watching movies ,TV shows, listening music of all sorts, reading  books and appreciating marvelous works of art then you will also love the MELA quiz which comprises questions from above topics.Abbreviated as Music Entertainment Literary Arts Quiz.If you love watching movies ,TV shows, listening music of all sorts, reading  books and appreciating marvelous works of art then you will also love the MELA quiz which comprises questions from above topics.</p>
        </div>
    </div>
    <div class="overlay__item" id="preview-2">
        <div class="box">
            <div class="box__shadow"></div>
            <img class="box__img box__img--original" src="img/gen_main.jpg" alt="Some image" />
            <h3 class="box__title"><span class="box__title-inner">15K</span></h3>
            <h4 class="box__text box__text--bottom box__text--right"><span class="box__text-inner box__text-inner--rotated3">General Quiz</span></h4>
        </div>
        <div class="overlay__content">
            <div class="myBtn">
                <a href="register.php?event=GENERAL QUIZ" data-title="Register"></a>
            </div>
            <p>If you like reading newspapers and be updated with the latest news all around the world be it politics,sports,business, technologies, stories ,etc then General Quiz would bring a lots of fun and surprises for you.</p>
        </div>
    </div>
    <div class="overlay__item" id="preview-3">
        <div class="box">
            <div class="box__shadow"></div>
            <img class="box__img box__img--original" src="img/brainwaves.jpg" alt="Some image" />
            <h3 class="box__title box__title--straight box__title--left"><span class="box__title-inner">10k</span></h3>
            <h4 class="box__text box__text--bottom box__text--right"><span class="box__text-inner box__text-inner--rotated3">BrainWaves</span></h4>
            <div class="box__deco box__deco--top">&#10153;</div>
        </div>
        <div class="overlay__content">
            <div class="myBtn">
                <a href="register.php?event=BRAINWAVES" data-title="Register"></a>
            </div>
            <p>“Much like life you don’t complete a puzzle by throwing away the pieces.”The world itself is a puzzle.The one who solves a puzzle attains the degree of paramatma(absolute supreme self).</p>
        </div>
    </div>
    <div class="overlay__item" id="preview-4">
        <div class="box">
            <div class="box__shadow"></div>
            <img class="box__img box__img--original" src="img/ockhamsrazor.jpg" alt="Some image" />
            <h3 class="box__title box__title--bottom"><span class="box__title-inner">10k</span></h3>
            <h4 class="box__text"><span class="box__text-inner box__text-inner--rotated2">Ockhams Razor</span></h4>
        </div>
        <div class="overlay__content">
            <div class="myBtn">
                <a href="register.php?event=OCKHAMS RAZOR" data-title="Register"></a>
            </div>
            <p>Online treasure hunt involves participants following clues and visit different websites/webpages to solve riddles.</p>
        </div>
    </div>
